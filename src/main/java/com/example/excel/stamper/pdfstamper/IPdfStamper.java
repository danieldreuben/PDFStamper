...
public class IPdfStamper  {
	...
	public void getPdfTemplate(String template) 
		throws Exception {
	...
	public void insertPage(String page, int position) 
		throws Exception {
	...
	public void setRandomGrid(int page) 
		throws Exception {
